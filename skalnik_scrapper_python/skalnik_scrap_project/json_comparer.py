...
def comparer():
    ...
    json_list = glob.glob('/home/fjed/Documents/vscode/SCRAP_1/skalnik_scrapper_python/skalnik_scrap_project/json_store/*.json') # chcange path of json_store dir
    ...
    return f'Products that changed since yesterday ({len(difference)}): {different_items}' 
comparer()